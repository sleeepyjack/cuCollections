...
struct window_extent {
  ...
  CUCO_HOST_DEVICE constexpr value_type value() const noexcept { return N; }
  CUCO_HOST_DEVICE explicit constexpr operator value_type() const noexcept { return value(); }

 private:
  CUCO_HOST_DEVICE explicit constexpr window_extent() noexcept {}
  CUCO_HOST_DEVICE explicit constexpr window_extent(SizeType) noexcept {}
