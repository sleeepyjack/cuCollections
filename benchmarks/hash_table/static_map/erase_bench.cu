...
void erase_bench(nvbench::state& state, nvbench::type_list<Pair, nvbench::enum_type<Dist>>)
{
...
NVBENCH_BENCH_TYPES(erase_bench,
                    NVBENCH_TYPE_AXES(defaults::pair_type_list,
                                      nvbench::enum_type_list<dist_type::UNIQUE>))
  .set_name("cuco::static_map::erase [matchi_rate]")
  .set_type_axes_names({"Pair", "Distribution"})
  .set_max_noise(defaults::max_noise)
